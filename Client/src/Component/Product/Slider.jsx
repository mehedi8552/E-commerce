...
import Slider__skeleton from "../../skeleton/Slider__skeleton.jsx";
const Slider = () => {
  const { SliderList } = PrductStore();

  if (SliderList === null) {
    return <Slider__skeleton />;
  } else {
    return (
      <div>
        <div
        ...
        >
              ...
              return (
                <div key={i} className={active} data-bs-interval="10000">
                  <div className="container">
                    <div className="row justify-content-center active">
          ...
          <button
            ...
            type="button"
            data-bstarget="#carouselExampleDark"
            data-bs-slide="prev"
          >
            <span
